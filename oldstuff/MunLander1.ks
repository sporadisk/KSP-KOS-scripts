...
SET InitialBurnVelocity TO 1000.
...
// Thrust Increment: More means more violent thrust usage. 0.02 = Up to 20% thrust change per second = 5 seconds from 0 to 100%.
SET ThrustIncrement TO 0.1.
